...
<div class="container">
    <a href="../home.php">home | </a> <a href="home_offer.php">Offers-home</a> | Tim-smart-fiber
    <hr>
    <div class="tabordion">
        <section id="section1">
            <input type="radio" name="sections" id="option1" checked>
            <label for="option1">Offer</label>
            <article>
                <h2>Offer</h2>
                <p>TIM SMART FIBER is the complete offer to ...</p>
                <ul>includes
                    <li>Internet conection</li>
                    <li>Phone line</li>
                    <li>Calls for 0€/min</li>
                    <li>TIMvision</li>
                </ul>
