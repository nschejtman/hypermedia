    ...
    <div>   
        <section class="grid-tv">               
                <div class="cont">          
                    ...
                    <h1>TIMvision</h1>   
                    <p>Cartoons, movies, TV series, documentaries and concerts always on demand to create your own schedule without advertising. More than 8,000 titles on a subscription, with no time constraints, even in HD on TV with dedicated decoder, Smart TV, PC, Smartphone and Tablet</p>   
        ...
        <ul class="grid-two">     
            <li>        
                <div class="cont">          
                    ...
                    <p>Select SMART TV best suited to your lifestyle. Enjoy the best entertainment with a next-generation TV.</p>   
            ...
            <li>        
                <div class="cont">        
                    ...
                    <p>  Choose from movies, series, cartoons and documentaries, always on demand, to create your TV programming without commercial breaks. </p>
