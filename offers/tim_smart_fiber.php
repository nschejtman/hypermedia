        ...
        <div class="col-md-8">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active grid-tv" id="offer-tab">
                    ...
                    <hr>
                    <iframe width="695" height="360" src="https://www.youtube.com/embed/5juwo46h0t8" frameborder="0" allowfullscreen></iframe>
                </div>
                <div role="tabpanel" class="tab-pane grid-tv" id="cost-tab">
                    <h2>Cost</h2>
                    <hr>
                    <h5>The costs set out below are those of the list and are applied except for any ongoing promotions to customers who require the activation of the offer TIM SMART FIBER by 31/07 /2016.Per details and information , see "Tim recalls".</h5>
                ...
                <div role="tabpanel" class="tab-pane grid-tv" id="faq-tab">
                    ...
                    <h5 style="margin-left: 30px">The RID is not mandatory but is required to get the discount on the contribution of the offer activation TIM SMART FIBER ( for free instead of € 49 for New Plants , passes by another operator , for existing customers with fixed line voice and TIM only for now TIM customers with fixed line with ADSL who switch to Fiber.</h5>
                    <h5 style="margin-left: 30px">If the promise of domiciliation , expired 90 days from the activation request of the offer TIM SMART FIBER , if the RID is not active will be charged the full amount of the contribution of the offer activation TIM SMART FIBER .</h5>
                    <h5 style="margin-left: 30px">The holder is not necessary that the TIM SMART contract is the same as the nominee of the bank RID .</h5>
